...
<div class="container mt-5 mb-5">
	...
	<table border="1" style="width: 700px">
		...
		<tr>
			...
			<td><form:input path="lectureroomPassword" type="password" class="form-control"/>
	...
	<div class="text-center button mt-3 5rem">
		...
		<a href="<c:url value="/lectureroom/list"/>?lectureId=${param.lectureId}" class="btn btn-dark mr-3" >목록</a>
